...
p(grid_8 alpha). The best way to contribute to MacRuby is by using it to build great things! If you happen to stumble across a bug along the way, be sure to file a "bug report":https://github.com/jballanc/MacRuby/issues. We also welcome any contributions to the MacRuby project itself. Check out the "wiki":https://github.com/MacRuby/MacRuby/wiki/Contributing-to-MacRuby for more information an ways you can contribute.
